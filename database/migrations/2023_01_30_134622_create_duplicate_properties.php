...
class CreateDuplicateProperties extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::table('properties', function (Blueprint $table) {
            $table->dropColumn('calendar_fallback');
        });

        Schema::table('properties', function (Blueprint $table) {
            $table->text('calendar_fallback')->after('airport')->nullable();
        });

        Schema::create('duplicate_properties', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('calendar_fallback')->nullable();
    ...
    {
        Schema::dropIfExists('duplicate_properties');
    }
}
